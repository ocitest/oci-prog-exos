...
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=1 | 648 | 1 |  Espion étranger
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=2 | 648 | 2 |  Maison de l'espion
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=4 | 648 | 4 |  Nombre de jours dans le mois
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=5 | 648 | 5 |  Amitié entre gardes
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=6 | 648 | 6 |  Nombre de personnes à la fête
...
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=9 | 648 | 9 |  Personne disparue
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=11 | 648 | 11 |  La grande fête
cours | http://www.france-ioi.org/algo/course.php?idChapter=648&idCourse=0&iOrder=12 | 648 | 12 |  Booléens : choses à ne pas faire
entrainement | http://www.france-ioi.org/algo/task.php?idChapter=648&idTask=0&sTab=task&iOrder=14 | 648 | 14 |  L'espion est démasqué !
